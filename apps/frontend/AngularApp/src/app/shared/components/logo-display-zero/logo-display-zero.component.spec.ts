...
import { LogoDisplayZeroComponent } from './logo-display-zero.component';


describe('LogoDisplayZeroComponent', () => {
  let cpnt: LogoDisplayZeroComponent;
  ...
  describe("init", () => {
    ...
    it("should have all values initalize properly", () => {
      expect(cpnt.myClass).toEqual('LogoDisplayZeroView')
    })
