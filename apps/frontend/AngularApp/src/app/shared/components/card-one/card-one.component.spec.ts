...
describe('CardOneComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await configureTestingModuleForComponents(CardOneComponent);
    

    ({fixture, cpnt} =  grabComponentInstance(CardOneComponent));
  ...
  describe("init", () => {
    ...
    it("should have all values initalize properly", () => {
      expect(cpnt.myClass).toEqual('CardOneView')
    })
