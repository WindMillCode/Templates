...
describe('RatingCardComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await configureTestingModuleForComponents(RatingCardComponent);


    ({fixture, cpnt} =  grabComponentInstance(RatingCardComponent));
  ...
  describe("init", () => {
    ...
    it("should have all values initalize properly", () => {
      expect(cpnt.myClass).toEqual('RatingCardView')
    })
