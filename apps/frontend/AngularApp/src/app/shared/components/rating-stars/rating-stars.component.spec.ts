...
describe('RatingStarsComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await configureTestingModuleForComponents(RatingStarsComponent);
    

    ({fixture, cpnt} =  grabComponentInstance(RatingStarsComponent));
  ...
  describe("init", () => {
    ...
    it("should have all values initalize properly", () => {
      expect(cpnt.myClass).toEqual('RatingStarsView')
    })
