...
describe('ColorOptionComponent', () => {
  ...
  beforeEach(async () => {
    ...
    await configureTestingModuleForComponents(ColorOptionComponent);
    

    ({fixture, cpnt} =  grabComponentInstance(ColorOptionComponent));
  ...
  describe("init", () => {
    ...
    it("should have all values initalize properly", () => {
      expect(cpnt.myClass).toEqual('ColorOptionView')
    })
