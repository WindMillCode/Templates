...
describe('ContactUsFormComponent', () => {
  let cpnt: ContactUsFormComponent;
  ...
  beforeEach(async () => {
    ...
    await configureTestingModuleForComponents(ContactUsFormComponent);


    ({fixture, cpnt} =  grabComponentInstance(ContactUsFormComponent));
  ...
  describe("init", () => {
    ...
    it("should have all values initalize properly", () => {
      expect(cpnt.myClass).toEqual('ContactUsFormView')
    })
