...
public class E2EUtils {
  ...
  public static final String PAGE_TITLE_PREFIX = "WindMillCode";
  ...
  public E2EUtils clickFromOptions(WebDriver driver, By selector,Integer optionIndex) {

    return clickFromOptions(driver,selector,optionIndex,0);
  }
  public E2EUtils clickFromOptions(WebDriver driver, By selector,Integer optionIndex,Integer waitTime) {
    WebDriverWait wait = new WebDriverWait(driver, waitTime);
    wait.until(ExpectedConditions.elementToBeClickable(selector));
    List<WebElement> targets = driver.findElements(selector);
    WebElement target = targets.get(optionIndex);
    target.click();
    return this;
  }
